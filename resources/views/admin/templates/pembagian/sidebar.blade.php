<aside class="app-sidebar">
    ...
    <ul class="app-menu">
      ...
      <li><a class="app-menu__item" href="{{ route('ktp.create') }}"><i class="app-menu__icon fa fa-book"></i><span class="app-menu__label">Tambah Nama</span></a></li>

       <li><a class="app-menu__item" href="#"><i class="app-menu__icon fa fa-user"></i><span class="app-menu__label">User</span></a></li>
